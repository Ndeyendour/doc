...
class _VerifyPinPageState extends State<VerifyPinPage> {
  ...
  _onPressedVerifyBtn() {
    ...
    if (customValidation) {
      final pinCode =
          '${_num1Ctrl.value.text}${_num2Ctrl.value.text}${_num3Ctrl.value.text}${_num4Ctrl.value.text}';
              ...
              _addHamiMaster().then((String addHamiRes) {
                ...
                if (addHamiMessage == 'Successful') {
                  _addPublicLogin().then((String addLoginRes) {
                    ...
                    if (addLoginMessage == 'User Created!' ||
                        addLoginMessage == 'Success!') {
  ...
  Future<String> _addPublicLogin() async {
    try {
      final url =
          '${Config.loginUrl}?module=${Config.loginModule}&mobile=$_userMobile&pwd=$_userPassword&upd=0&ins=1&api_key=${Config.apiKey}';
