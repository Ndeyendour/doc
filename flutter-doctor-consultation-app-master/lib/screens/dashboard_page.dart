    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      if (remoteNotification != null && androidNotification != null) {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => NotificationPage(mobile: widget.mobile)));
      }
    });
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar(
            elevation: 0,
            backgroundColor: kColorforegroundColor, //ios status bar colors
            systemOverlayStyle: const SystemUiOverlayStyle(
              statusBarColor: kColorforegroundColor, //android status bar color
